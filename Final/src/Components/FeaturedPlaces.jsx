...
const  [cardView, setCardView] = useState(false)
  ...
  return (
    <>
      ...
      <Card   onMouseEnter={()=>setCardView(true)} onMouseLeave={()=>setCardView(false)} className={`py-4 absolute left-2 top-5 bg-[#FAFAFB] shadow-2xl w-[22rem] flex-col transition-all duration-500 translate-x-[-90%] max-sm:hidden ${isOpen ? "hidden" : ""} ${cardView ? "translate-x-0" : ""}`}>
