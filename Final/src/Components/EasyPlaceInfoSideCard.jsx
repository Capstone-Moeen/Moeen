...
function EasyPlaceInfoSideCard() {
  ...
  return (
    <>
      <Card
        className={`bg-[#FAFAFB] shadow-2xl   right-7 w-[37rem] flex flex-col justify-center items-center h-[85%] top-14 max-sm:right-2 overflow-hidden max-sm:w-[95%]`}
      >
        <Card
          className={`bg-[#FAFAFB] shadow-2xl rounded  w-full flex flex-col justify-center items-center h-[90vh]   overflow-y-auto`}
        >
          <div className="w-full">
            <Image
              width="100%"
              className={`object-fit ${
                selected === "details" ? "" : "pt-[17rem]"
              }  rounded-none`}
