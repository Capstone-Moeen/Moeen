  ...
  return (
    <>
      <Card
        ...
        }    py-2 bg-[#FAFAFB] shadow-2xl absolute right-5 w-[32rem] flex flex-col justify-center items-center h-[85%] top-5 max-sm:right-2 overflow-y-visible `}
      >
        <CardHeader
          className={`pb-0  px-2 flex-col  ${
            selected === "details" ? "" : "pt-[26rem]"
          }`}
        >
          <Image
            width="100%"
